...
public:
	...
	void reset();
	void reset(float xNew, float yNew, float zNew, float yawNew);
	...
	svcl_ardrone_automation::filter_state getCurrentPoseSpeed();
	...
	svcl_ardrone_automation::filter_state getPoseAt(ros::Time t, bool useControlGains = true);
