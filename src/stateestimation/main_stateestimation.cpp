...
int main(int argc, char **argv)
{
  ...
  dynamic_reconfigure::Server<svcl_ardrone_automation::StateestimationParamsConfig> srv;
  dynamic_reconfigure::Server<svcl_ardrone_automation::StateestimationParamsConfig>::CallbackType f;
